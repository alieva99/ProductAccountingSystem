...
namespace ProductAccountingSystem
{
    ...
    {
        public event Action supplierAdded; // Событие для уведомления о добавлении 
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(supplierName) || supplierName == "Введите..." || string.IsNullOrWhiteSpace(email) || email == "Введите..." || string.IsNullOrWhiteSpace(phone_number) || phone_number == "Введите...")
            {
            ...
            {
                conn.Open();
                string query = "INSERT INTO suppliers (supplier_name, email, phone_number) VALUES (@supplier_name, @email, @phone_number)";
                ...
                try
                {
                    ...
                    supplierAdded?.Invoke(); // Уведомляем об добавлении продукта
                }
                catch (Exception ex)
                {
